...
export const ASSISTANT_SYSTEM_PROMPT = `Tu es "RecyGo Assistant", l'assistant officiel de l'application RecyGo CI.
...
export const OFF_TOPIC_GEMINI_PROMPT = `Tu es un filtre de contenu pour une application de recyclage.
