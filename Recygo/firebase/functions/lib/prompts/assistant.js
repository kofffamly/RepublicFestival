...
exports.OFF_TOPIC_DETECTION_PROMPT = exports.ASSISTANT_SYSTEM_PROMPT = void 0;
exports.ASSISTANT_SYSTEM_PROMPT = `Tu es "RecyGo Assistant", un assistant virtuel spécialisé dans le recyclage et la gestion des déchets en Côte d'Ivoire.
 ...
 */
exports.OFF_TOPIC_DETECTION_PROMPT = `Tu es un filtre de contenu. Analyse le message suivant et réponds UNIQUEMENT par true ou false.
